...
-- in a separate file and .gitignore it as it contains credentialsUSE ROLE USERADMIN;
...
GRANT ROLE movies_reader TO USER ANJASCHE; -- fill in your own user name here